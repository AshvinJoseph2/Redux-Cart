      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            ...
            <Link to={'/cart'} className='text-decoration-none text-light fw-bold ms-md-5'><FontAwesomeIcon icon={faCartPlus} className='me-1  text-success' />Cart <Badge pill bg="secondary">10</Badge></Link>
          </Nav>
        </Navbar.Collapse>
      </Container>
    </Navbar>
