...
function Home() {
    ...
    const currenPageLastIndex = currentPage * productPerPage
    const currenPageFirstIndex = currenPageLastIndex - productPerPage
    const visibleProductArray = allProducts?.slice(currenPageFirstIndex,currenPageLastIndex)
            ...
            <div className='m-5'>
                {
                    ...
                    <div className='p-5 text-center'>
                        <img width={'100px'} src="https://icon-library.com/images/loading-icon-transparent-background/loading-icon-transparent-background-12.jpg" alt="loading" />
                    ...
                    <div className='row pt-5'>
                    {
                        ...
                        :
                        <p className='fw-bold fs-5'>Products Not Found!!!</p>
                    }
